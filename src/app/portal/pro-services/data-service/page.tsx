...
export default function DataService() {
  ...
  return (
    <div className="pb-[100px] bg-[#fafbfc] min-h-screen font-['PingFang_SC','Microsoft_YaHei',Arial,sans-serif]">
      ...
      <section
        ref={heroRef}
        className={`text-center pt-[150px] pb-[90px] relative overflow-hidden opacity-10 shadow-[0_4px_24px_rgba(229,57,53,0.06)] transition-all duration-1000 ${
          isHeroInView
      ...
      <Flow
        onProcessClick={() =>
          router.push('/portal/pro-services/data-service/process')
        }
      />
